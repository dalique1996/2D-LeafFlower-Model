...
////----------------VERTEX DATA----------------------//
  ...
  public:
      Chemics(const Process& process)
          ...
          //Source
          addParm("b0 source", "Source Auxin Bottom", "2.5");
          addParm("b1 source", "Source Auxin Bottom", "22");
          addParm("b2 source", "Source Auxin Bottom", "1.5");
          addParm("b3 source", "Source Auxin Bottom", "3");
          addParm("t0 source", "Source Auxin Top", "2.5");
          addParm("t1 source", "Source Auxin Top", "22");
          addParm("t2 source", "Source Auxin Top", "2");
